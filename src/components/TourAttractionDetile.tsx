  ...
  return (
    <View style={styles.view}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.view2}>
          <Text style={[styles.text, {fontSize: 16, marginBottom: 10, marginTop: 10}]}>관광지소개글관광지소개글관광지소개글관광지소개글관광지소개글관광지소개글</Text>
        </View>
        <View style={styles.view2}>
          <TouchableOpacity
            disabled={true}
        ...
        <View style={styles.view2}>
          <Text style={[styles.text, {color: '#666', marginRight: 15}]}>홈페이지</Text>
          <Text style={styles.text}>http://www.abcd.net/kr/</Text>
        </View>
        <View style={styles.view2}>
          <Text style={[styles.text, {color: '#666', marginRight: 40}]}>주차</Text>
        ...
        <View style={styles.view2}>
          <Text style={styles.text}>관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글관광지상세소개글</Text>
        </View>
        <Image style={styles.image2} source={require('../assets/images/swiper1_main.png')} />
        <View style={styles.view2}>
          <TouchableOpacity
            disabled={true}
            style={{
